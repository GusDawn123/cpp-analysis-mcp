...
# `#1 0x... in main /w/leak.cpp:6:28`. Paths with spaces truncate here -- the format is
# unquoted and function names carry spaces too, so the boundary is unrecoverable
